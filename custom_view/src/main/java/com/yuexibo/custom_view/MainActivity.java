package com.yuexibo.custom_view;
...
public class MainActivity extends AppCompatActivity {
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_path, R.string.arcto, R.layout.practice_arcto));
        pageModels.add(new PageModel(R.layout.sample_path, R.string.cwcww, R.layout.practice_filltype));
        pageModels.add(new PageModel(R.layout.sample_path, R.string.bitmapAndText, R.layout.practice_bitmaptext));
    }
