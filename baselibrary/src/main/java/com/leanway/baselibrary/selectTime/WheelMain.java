...
public class WheelMain {
	...
	public String getTime() {
		...
		if (iTime == 1) {
			...
			sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
					.append(addZero(wv_month.getCurrentItem() + 1)).append("-")
					.append(addZero(wv_day.getCurrentItem() + 1)).append(" ")
					.append(addZero(wv_hours.getCurrentItem())).append(":")
					.append(addZero(wv_mins.getCurrentItem()));
		} else if (iTime == 2) {
