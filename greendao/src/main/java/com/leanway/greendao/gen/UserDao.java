...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Hid = new Property(4, Long.class, "hid", false, "HID");
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // hid
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setHid(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
    ...
    protected User loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Head mHead = loadCurrentOther(daoSession.getHeadDao(), cursor, offset);
        entity.setMHead(mHead);
        offset += daoSession.getHeadDao().getAllColumns().length;

        City mCity = loadCurrentOther(daoSession.getCityDao(), cursor, offset);
        entity.setMCity(mCity);
